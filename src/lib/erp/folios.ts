 ...
 * Devuelve el folio formateado, p.ej. `"COT-A-0001"`.
 *
 * PROPIEDAD DEL ORQUESTADOR (pieza compartida F1). Los 4 submódulos la consumen
 * para numerar sus documentos sin reimplementar la lógica de series.
 */
